...
public interface IMultiplayerLobby : IChatChannel
{
	...
	public Task MoveAsync(MultiplayerPlayer player, int slot);
	...
	public Task SetHostAsync(MultiplayerPlayer player);
	...
	public Task KickAsync(MultiplayerPlayer player);
	public Task BanAsync(MultiplayerPlayer player);
